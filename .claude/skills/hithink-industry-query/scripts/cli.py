...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="问财行业数据 - 行业数据查询工具",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=f"""
使用示例:
  python3 scripts/cli.py --query "A股行业估值排名"
  python3 scripts/cli.py --query "银行业盈利数据"
  python3 scripts/cli.py --query "新能源板块行情" --page "2" --limit "20"
  python3 scripts/cli.py --query "行业涨跌幅排名" --api-key "your-key"
